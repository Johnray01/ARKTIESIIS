...
This repository contains the project foundation, email authentication, database administration, student and academic records, the Phase 7 finance workspace, document management, local OCR, and advisory document review. Real native-tool acceptance remains pending; policy-dependent Phase 10 acceptance checks remain on hold until the school approves document requirements and review rules.
